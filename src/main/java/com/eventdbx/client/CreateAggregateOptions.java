...
public final class CreateAggregateOptions {
    ...
    private CreateAggregateOptions(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CreateAggregateOptions build() {
            return new CreateAggregateOptions(this);
        }
    }
}
